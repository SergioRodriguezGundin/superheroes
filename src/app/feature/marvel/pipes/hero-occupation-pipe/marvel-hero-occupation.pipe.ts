...
const HERO_OCCUPATION_DEFAULT = 'superhero';

@Pipe({
  name: 'marvelHeroOccupation',
  standalone: true
})
export class MarvelHeroOccupationPipe implements PipeTransform {
  ...
  transform(occupation: string = HERO_OCCUPATION_DEFAULT): HeroPropertiePipeConfig {
